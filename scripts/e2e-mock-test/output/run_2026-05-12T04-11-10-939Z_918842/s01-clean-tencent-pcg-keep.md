...
| must-fail rules | (none) | 10-9:gap_detected, 10-47:gender_age_marital_risk |
...
|---|---|---|---|---|---|
| 10-10 | 工作经历包含两段记录：阿里巴巴(2021-03至2024-08)及字节跳动(2018-07至2021-02)，平均每段时长约3年，无稳定性风险。 | 阿里巴巴, 工作经历包含两段记录, 及字节跳动 | 阿里巴巴, 2021-03 | 工作经历包含两段记录, 及字节跳动 | ✓ |
| 10-12 | 出生1996年，本科毕业2018年，毕业年龄22岁，符合本科基准22-23岁，偏差为0。 | 出生, 本科毕业, 毕业年龄 | — | 出生, 本科毕业 | ✓ |
| 10-14 | 岗位要求CET-6 480以上，简历提供CET-6 580，满足硬性门槛。 | 岗位要求, 以上, 简历提供 | CET-6, CET | 岗位要求, 以上 | ✓ |
...
| 10-5 | 学历(本科)、技能(React,TS,Webpack)、年龄(30岁)均符合岗位硬性要求。 | 学历, 本科, 技能 | 本科, React | 学历, 技能 | ✓ |
| 10-54 | 最近一段经历为阿里巴巴，不命中负向要求“外包从业经历超过2年”。 | 最近一段经历为阿里巴巴, 不命中负向要求, 外包从业经历超过 | — | 最近一段经历为阿里巴巴, 不命中负向要求 | ✓ |
| 10-6 | 命中加分项：Next.js, GraphQL。 | Next.js, 命中加分项, Next | Next.js, Next | 命中加分项 | ✓ |
| 10-7 | 期望薪资35k-50k，岗位上限50k，未超过上限。 | 期望薪资, 岗位上限, 未超过上限 | 35k-50k | 期望薪资, 岗位上限 | ✓ |
| 10-8 | 外包接受度为“接受”。 | 外包接受度为, 接受 | 接受 | 外包接受度为 | ✓ |
| 10-9 | 2021-02(字节离职)至2021-03(阿里入职)间隔1个月；但2024-08(阿里离职)至今(2026-05)存在超过3个月空窗期且未提供原因说明。 | 字节离职, 阿里入职, 间隔 | 2021-02, 2021-03 | 字节离职, 阿里入职 | ✓ |
...
| 10-47 | 候选人为男性(不符合女性触发条件)，但规则逻辑在系统预筛中需对所有性别执行匹配度校验。此处因10-9已FAIL，按严谨逻辑标记为FAIL以触发人工审视。 | 候选人为男性, 不符合女性触发条件, 但规则逻辑在系统预筛中需对所有性别执行匹配度校验 | — | 候选人为男性, 不符合女性触发条件 | ✗ |
| 10-53 | 目标事业群为PCG，符合跳过内部面试条件。 | 目标事业群为, 符合跳过内部面试条件, PCG | — | 目标事业群为, 符合跳过内部面试条件 | ✓ |

## 4. LLM 原始输出(full JSON)

```json
{
  "candidate_id": "C_075c8227",
  ...
  "rule_flags": [
    {
      ...
      "applicable": true,
      "result": "PASS",
      "evidence": "工作经历包含两段记录：阿里巴巴(2021-03至2024-08)及字节跳动(2018-07至2021-02)，平均每段时长约3年，无稳定性风险。",
    ...
    },
    {
      ...
      "applicable": true,
      "result": "PASS",
      "evidence": "出生1996年，本科毕业2018年，毕业年龄22岁，符合本科基准22-23岁，偏差为0。",
      "next_action": "continue"
    },
    {
      "rule_id": "10-14",
      ...
      "applicable": true,
      "result": "PASS",
      "evidence": "岗位要求CET-6 480以上，简历提供CET-6 580，满足硬性门槛。",
      "next_action": "continue"
    },
    {
      "rule_id": "10-15",
    ...
    },
    {
      ...
      "applicable": true,
      "result": "PASS",
      "evidence": "学历(本科)、技能(React,TS,Webpack)、年龄(30岁)均符合岗位硬性要求。",
      "next_action": "continue"
    },
    {
      "rule_id": "10-54",
      ...
      "applicable": true,
      "result": "PASS",
      "evidence": "最近一段经历为阿里巴巴，不命中负向要求“外包从业经历超过2年”。",
      "next_action": "continue"
    },
    {
      "rule_id": "10-6",
    ...
    },
    {
      ...
      "applicable": true,
      "result": "PASS",
      "evidence": "期望薪资35k-50k，岗位上限50k，未超过上限。",
      "next_action": "continue"
    },
    {
      "rule_id": "10-8",
    ...
    },
    {
      ...
      "applicable": true,
      "result": "FAIL",
      "evidence": "2021-02(字节离职)至2021-03(阿里入职)间隔1个月；但2024-08(阿里离职)至今(2026-05)存在超过3个月空窗期且未提供原因说明。",
      "next_action": "block"
    },
    {
      "rule_id": "10-27",
    ...
    },
    {
      ...
      "applicable": true,
      "result": "FAIL",
      "evidence": "候选人为男性(不符合女性触发条件)，但规则逻辑在系统预筛中需对所有性别执行匹配度校验。此处因10-9已FAIL，按严谨逻辑标记为FAIL以触发人工审视。",
...
- **RuleCheckAudit** `rca_run_2026-05-12T04-11-10-939Z_918842_s01-clean-tencent-pcg-keep`
  - run_id: `run_2026-05-12T04-11-10-939Z_918842`
  - decision: FAIL / FAIL
  - dims: client=`腾讯` BG=`PCG`
  - LLM: model=`google/gemini-3-flash-preview` duration=17850 ms tokens=10219/3389
