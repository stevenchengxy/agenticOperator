...
| must-fail rules | 10-38 | parse-error:no-parsed-json |
...
- **RuleCheckAudit** `rca_run_2026-05-12T04-10-46-198Z_f889c7_s04-tencent-history-cross-studio`
  - run_id: `run_2026-05-12T04-10-46-198Z_f889c7`
  - decision: FAIL / UNKNOWN
  - dims: client=`腾讯` BG=`IEG`
  - LLM: model=`stub:deterministic` duration=10 ms tokens=5996/2404
