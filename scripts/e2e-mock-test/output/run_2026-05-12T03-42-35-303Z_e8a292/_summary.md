# E2E Mock Test Run — run_2026-05-12T03-42-35-303Z_e8a292

**Result: 5/10 scenarios passed**
...
| 3 | [s03-csi-blacklist-drop](s03-csi-blacklist-drop.md) | FAIL (FAIL) | 74% | ❌ FAIL (6/7 assertions) |
| 4 | [s04-tencent-history-cross-studio](s04-tencent-history-cross-studio.md) | FAIL (FAIL) | 94% | ✅ PASS |
...
| 9 | [s09-tencent-history-to-bytedance](s09-tencent-history-to-bytedance.md) | FAIL (FAIL) | 94% | ❌ FAIL (7/9 assertions) |
...
**Aggregate verifiability: 147/155 (95%)**
