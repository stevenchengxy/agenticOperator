...
|---|---|---|---|---|---|
| 10-10 | 平均每段工作时长约3年（2018-07至2021-02, 2021-03至2024-08），无消极空窗期理由。 | 平均每段工作时长约, 无消极空窗期理由, 2018-07 | 2018-07, 2021-02 | 平均每段工作时长约, 无消极空窗期理由 | ✓ |
| 10-12 | 1996年出生，2018年本科毕业，毕业年龄22岁，符合基准（22-23岁），偏差为0。 | 年出生, 年本科毕业, 毕业年龄 | — | 年出生, 年本科毕业 | ✓ |
| 10-24 | 简历已关联至原始需求 jr_y88。 | 简历已关联至原始需求 | — | 简历已关联至原始需求 | ✓ |
| 10-25 | 工作经历中未包含华为、荣耀及其关联公司。 | 工作经历中未包含华为, 荣耀及其关联公司 | — | 工作经历中未包含华为, 荣耀及其关联公司 | ✓ |
| 10-26 | 工作经历中未包含OPPO、小米及其关联公司。 | 工作经历中未包含, 小米及其关联公司, OPPO | — | 工作经历中未包含, 小米及其关联公司 | ✓ |
...
| 10-7 | 期望薪资 35k-50k，岗位上限 40k。由于技能不匹配（10-5），综合得分必然低于90分，判定为薪资不匹配。 | 期望薪资, 岗位上限, 由于技能不匹配 | 35k-50k | 期望薪资, 岗位上限 | ✓ |
| 10-8 | 外包接受程度为'接受'。 | 接受, 外包接受程度为 | 接受 | 外包接受程度为 | ✓ |
| 10-9 | 2024-08 至今（2026-05）存在超过3个月空窗期，且未提供空窗期原因说明。 | 至今, 存在超过, 个月空窗期 | 2024-08 | 至今, 存在超过 | ✓ |
...
| 10-47 | 候选人为女性，30岁（>26岁），已婚已育。虽然已育，但根据规则逻辑，命中加分项比例为0（未达半数），维持禁止推荐状态。 | 候选人为女性, 已婚已育, 虽然已育 | 已婚已育 | 候选人为女性, 虽然已育 | ✓ |
  ...
  "rule_flags": [
    {
      ...
      "applicable": true,
      "result": "PASS",
      "evidence": "平均每段工作时长约3年（2018-07至2021-02, 2021-03至2024-08），无消极空窗期理由。",
    ...
    },
    {
      ...
      "applicable": true,
      "result": "PASS",
      "evidence": "1996年出生，2018年本科毕业，毕业年龄22岁，符合基准（22-23岁），偏差为0。",
      "next_action": "continue"
    },
    {
      "rule_id": "10-14",
    ...
    },
    {
      ...
      "applicable": true,
      "result": "PASS",
      "evidence": "工作经历中未包含OPPO、小米及其关联公司。",
      "next_action": "continue"
    },
    {
      "rule_id": "10-29",
    ...
    },
    {
      ...
      "applicable": true,
      "result": "FAIL",
      "evidence": "期望薪资 35k-50k，岗位上限 40k。由于技能不匹配（10-5），综合得分必然低于90分，判定为薪资不匹配。",
      "next_action": "block"
    },
    {
      "rule_id": "10-8",
    ...
    },
    {
      ...
      "applicable": true,
      "result": "FAIL",
      "evidence": "2024-08 至今（2026-05）存在超过3个月空窗期，且未提供空窗期原因说明。",
      "next_action": "block"
    },
    {
      "rule_id": "10-27",
    ...
    },
    {
      ...
      "applicable": true,
      "result": "FAIL",
      "evidence": "候选人为女性，30岁（>26岁），已婚已育。虽然已育，但根据规则逻辑，命中加分项比例为0（未达半数），维持禁止推荐状态。",
...
- **RuleCheckAudit** `rca_run_2026-05-12T03-42-35-303Z_e8a292_s10-clean-tencent-cdg`
  - run_id: `run_2026-05-12T03-42-35-303Z_e8a292`
  - decision: FAIL / FAIL
  - dims: client=`腾讯` BG=`CDG`
  - LLM: model=`google/gemini-3-flash-preview` duration=15682 ms tokens=10088/3380
