...
| must-fail rules | 10-49 | 10-9:gap_detected, 10-49:former_bytedance_employee, 10-25:competitor_cooldown |
...
|---|---|---|---|---|---|
| 10-10 | 平均每段工作时长约2年（2020-07至2024-03，2024-04至2026-04），未命中稳定性风险。 | 平均每段工作时长约, 未命中稳定性风险, 2020-07 | 2020-07, 2024-03 | 平均每段工作时长约, 未命中稳定性风险 | ✓ |
| 10-12 | 1995年出生，2020年本科毕业，毕业年龄25岁，偏差2岁（基准23岁），在允许范围内。 | 年出生, 年本科毕业, 毕业年龄 | — | 年出生, 年本科毕业 | ✓ |
| 10-14 | 岗位要求CET-6 480以上，候选人提供CET-6 550，满足要求。 | 岗位要求, 以上, 候选人提供 | CET-6, CET | 岗位要求, 以上 | ✓ |
...
| 10-9 | 毕业时间2020-06与首份工作2020-07间隔不足3个月；但美团(2024-04)与字节(2024-03)之间存在空窗且原因说明为空。 | 毕业时间, 与首份工作, 间隔不足 | 2020-07, 2024-04 | 毕业时间, 与首份工作 | ✓ |
| 10-1 | 新需求下发，符合转推逻辑。 | 新需求下发, 符合转推逻辑 | — | 新需求下发, 符合转推逻辑 | ✓ |
| 10-11 | 候选人意向为正编，与岗位招聘类型匹配。 | 候选人意向为正编, 与岗位招聘类型匹配 | — | 候选人意向为正编, 与岗位招聘类型匹配 | ✓ |
| 10-21 | 候选人30岁，未超过岗位上限32岁。 | 候选人, 未超过岗位上限 | — | 候选人, 未超过岗位上限 | ✓ |
| 10-49 | 候选人曾于2020-07至2024-03在字节跳动任职前端工程师/架构师。 | 候选人曾于, 在字节跳动任职前端工程师, 架构师 | 架构师, 2020-07 | 候选人曾于, 在字节跳动任职前端工程师 | ✓ |

## 4. LLM 原始输出(full JSON)

```json
{
  "candidate_id": "R_cd84ad",
  ...
  "rule_flags": [
    {
      ...
      "applicable": true,
      "result": "PASS",
      "evidence": "平均每段工作时长约2年（2020-07至2024-03，2024-04至2026-04），未命中稳定性风险。",
    ...
    },
    {
      ...
      "applicable": true,
      "result": "PASS",
      "evidence": "1995年出生，2020年本科毕业，毕业年龄25岁，偏差2岁（基准23岁），在允许范围内。",
      "next_action": "continue"
    },
    {
      "rule_id": "10-14",
      ...
      "applicable": true,
      "result": "PASS",
      "evidence": "岗位要求CET-6 480以上，候选人提供CET-6 550，满足要求。",
      "next_action": "continue"
    },
    {
      "rule_id": "10-15",
    ...
    },
    {
      ...
      "applicable": true,
      "result": "FAIL",
      "evidence": "毕业时间2020-06与首份工作2020-07间隔不足3个月；但美团(2024-04)与字节(2024-03)之间存在空窗且原因说明为空。",
      "next_action": "block"
    },
    {
      "rule_id": "10-1",
    ...
    },
    {
      ...
      "applicable": false,
      "result": "NOT_APPLICABLE",
      "evidence": "简历中未显示通过友商派驻字节的经历（简历显示为字节跳动直接任职）。",
      "next_action": "continue"
    },
    {
      "rule_id": "10-36",
    ...
    },
    {
      ...
      "applicable": true,
      "result": "FAIL",
      "evidence": "候选人曾于2020-07至2024-03在字节跳动任职前端工程师/架构师。",
...
- **RuleCheckAudit** `rca_run_2026-05-12T03-42-35-303Z_e8a292_s08-bytedance-cooldown-expired`
  - run_id: `run_2026-05-12T03-42-35-303Z_e8a292`
  - decision: FAIL / FAIL
  - dims: client=`字节` BG=`TikTok`
  - LLM: model=`google/gemini-3-flash-preview` duration=16858 ms tokens=10066/3496
