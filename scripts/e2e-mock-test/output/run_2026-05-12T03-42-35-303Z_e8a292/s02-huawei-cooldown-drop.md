...
| must-fail rules | 10-25 | 10-25:competitor_cooldown, 10-9:gap_detected |
...
|---|---|---|---|---|---|
| 10-10 | 平均每段工作时长：华为(6.75年)+京东(1.8年)，均大于1年，无稳定性风险。 | 华为, 平均每段工作时长, 京东 | 华为, 京东 | 平均每段工作时长, 均大于 | ✓ |
| 10-12 | 出生1992年，2017年本科毕业，毕业年龄25岁，对比基准22-23岁偏差2岁，处于正常波动范围。 | 出生, 年本科毕业, 毕业年龄 | — | 出生, 年本科毕业 | ✓ |
...
| 10-5 | 学历本科、技能React/TS、语言CET-6、年龄33岁均满足JD硬性门槛。 | 学历本科, 技能, 语言 | CET-6, React | 学历本科, 技能 | ✓ |
| 10-6 | 命中加分项：Next.js。 | Next.js, 命中加分项, Next | Next.js, Next | 命中加分项 | ✓ |
| 10-7 | 期望薪资40k-50k，岗位薪资30k-50k，未超过上限。 | 期望薪资, 岗位薪资, 未超过上限 | 40k-50k | 期望薪资, 岗位薪资 | ✓ |
| 10-8 | 外包接受度为“接受”。 | 外包接受度为, 接受 | 接受 | 外包接受度为 | ✓ |
| 10-9 | 2026-03离职至今（2026-05-12）不足3个月，但京东与华为之间（2019-05至2019-06）无空窗；毕业与首份工作（2017-07）无空窗。此处标记为FAIL系因规则要求检测空窗原因说… | 离职至今, 不足, 个月 | 2026-03, 2019-05 | 离职至今, 不足 | ✓ |
| 10-11 | 意向为正编，符合岗位招聘类型。 | 意向为正编, 符合岗位招聘类型 | — | 意向为正编, 符合岗位招聘类型 | ✓ |
| 10-21 | 候选人33岁，岗位上限32岁，超出1岁。按规则判定为FAIL。 | 候选人, 岗位上限, 超出 | — | 候选人, 岗位上限 | ✓ |
| 10-36 | 候选人为男性，不触发该规则。 | 候选人为男性, 不触发该规则 | — | 候选人为男性, 不触发该规则 | ✓ |

## 4. LLM 原始输出(full JSON)

```json
{
  "candidate_id": "R_33405a",
  ...
  "rule_flags": [
    {
      ...
      "applicable": true,
      "result": "PASS",
      "evidence": "平均每段工作时长：华为(6.75年)+京东(1.8年)，均大于1年，无稳定性风险。",
    ...
    },
    {
      ...
      "applicable": true,
      "result": "PASS",
      "evidence": "出生1992年，2017年本科毕业，毕业年龄25岁，对比基准22-23岁偏差2岁，处于正常波动范围。",
      "next_action": "continue"
    },
    {
      "rule_id": "10-14",
    ...
    },
    {
      ...
      "applicable": true,
      "result": "PASS",
      "evidence": "学历本科、技能React/TS、语言CET-6、年龄33岁均满足JD硬性门槛。",
      "next_action": "continue"
    },
    {
      "rule_id": "10-54",
    ...
    },
    {
      ...
      "applicable": true,
      "result": "PASS",
      "evidence": "期望薪资40k-50k，岗位薪资30k-50k，未超过上限。",
      "next_action": "continue"
    },
    {
      "rule_id": "10-8",
    ...
    },
    {
      ...
      "applicable": true,
      "result": "FAIL",
      "evidence": "2026-03离职至今（2026-05-12）不足3个月，但京东与华为之间（2019-05至2019-06）无空窗；毕业与首份工作（2017-07）无空窗。此处标记为FAIL系因规则要求检测空窗原因说明，简历未提供2026-03后的状态说明。",
      "next_action": "block"
    },
    {
      "rule_id": "10-1",
    ...
    },
    {
      ...
      "applicable": true,
      "result": "PASS",
      "evidence": "候选人33岁，岗位上限32岁，超出1岁。按规则判定为FAIL。",
      "next_action": "block"
    },
    {
      "rule_id": "10-22",
...
- **RuleCheckAudit** `rca_run_2026-05-12T03-42-35-303Z_e8a292_s02-huawei-cooldown-drop`
  - run_id: `run_2026-05-12T03-42-35-303Z_e8a292`
  - decision: FAIL / FAIL
  - dims: client=`字节` BG=`TikTok`
  - LLM: model=`google/gemini-3-flash-preview` duration=18816 ms tokens=10077/3469
