...
| must-fail rules | 10-17 | 10-17:high_risk_rehire, 10-5:hard_requirement_mismatch, 10-9:gap_reason_missing, 10-38:tencent_history_check |
...
- ✅ **evidence verifiable rate ≥ 0.8 (got 90%)** — verified=19 / total=21
...
|---|---|---|---|---|---|
| 10-10 | 平均每段工作时长约 3 年（2020-03至2023-05，2023-06至2026-04），稳定性正常。 | 平均每段工作时长约, 稳定性正常, 2020-03 | 2020-03, 2023-05 | 平均每段工作时长约, 稳定性正常 | ✓ |
| 10-12 | 出生1988年，本科毕业2014年，毕业年龄26岁，偏差26-23=3岁，虽有偏差但逻辑基本合理。 | 出生, 本科毕业, 毕业年龄 | — | 出生, 本科毕业 | ✓ |
| 10-14 | 岗位要求CET-6 480以上，简历仅提供CET-4。 | 岗位要求, 以上, 简历仅提供 | CET-4, CET | 岗位要求, 以上 | ✓ |
| 10-16 | 离职编码为B8，属于高风险编码，由10-17规则处理，本规则不命中。 | 离职编码为, 属于高风险编码, 规则处理 | — | 离职编码为, 属于高风险编码 | ✓ |
| 10-17 | 候选人曾任职于华腾，离职原因为B8有犯罪记录(YCH)，命中高风险类型。 | 候选人曾任职于华腾, 离职原因为, 有犯罪记录 | 有犯罪记录, YCH | 候选人曾任职于华腾, 离职原因为 | ✓ |
...
| 10-5 | 技能不匹配：岗位要求React, TypeScript, Webpack，简历仅有Java相关技能；语言不匹配：要求CET-6，简历为CET-4。 | 岗位要求React, 要求CET-6, 技能不匹配 | CET-4, Java | 岗位要求React, 要求CET-6 | ✓ |
| 10-54 | 最近一段经历为某互联网公司，未命中负向要求“外包经历超过2年”（华腾经历非最近一段）。 | 最近一段经历为某互联网公司, 未命中负向要求, 外包经历超过 | — | 最近一段经历为某互联网公司, 未命中负向要求 | ✓ |
...
| 10-9 | 2014年毕业至2020年首份工作之间存在多年空窗且无原因说明。 | 年毕业至, 年首份工作之间存在多年空窗且无原因说明 | — | 年毕业至, 年首份工作之间存在多年空窗且无原因说明 | ✗ |
| 10-27 | conflict_of_interest 为空。 | 为空 | — | 为空 | ✓ |
| 10-35 | 国籍为中国。 | 国籍为中国 | — | 国籍为中国 | ✗ |
| 10-38 | 简历包含“华腾”经历，属于腾讯外包合作伙伴，需核实离场原因。 | 简历包含, 华腾, 经历 | 华腾 | 简历包含, 经历 | ✓ |
| 10-45 | 未发现腾讯正式岗位工作记录。 | 未发现腾讯正式岗位工作记录 | — | 未发现腾讯正式岗位工作记录 | ✓ |
...
```json
{
  ...
  "rule_flags": [
    {
      ...
      "applicable": true,
      "result": "PASS",
      "evidence": "平均每段工作时长约 3 年（2020-03至2023-05，2023-06至2026-04），稳定性正常。",
    ...
    },
    {
      ...
      "applicable": true,
      "result": "PASS",
      "evidence": "出生1988年，本科毕业2014年，毕业年龄26岁，偏差26-23=3岁，虽有偏差但逻辑基本合理。",
      "next_action": "continue"
    },
    {
      "rule_id": "10-14",
      ...
      "applicable": true,
      "result": "FAIL",
      "evidence": "岗位要求CET-6 480以上，简历仅提供CET-4。",
      "next_action": "block"
    },
    {
      "rule_id": "10-15",
    ...
    },
    {
      ...
      "applicable": true,
      "result": "PASS",
      "evidence": "离职编码为B8，属于高风险编码，由10-17规则处理，本规则不命中。",
      "next_action": "continue"
    },
    {
      "rule_id": "10-17",
      ...
      "applicable": true,
      "result": "FAIL",
      "evidence": "候选人曾任职于华腾，离职原因为B8有犯罪记录(YCH)，命中高风险类型。",
      "next_action": "block"
    },
    {
      "rule_id": "10-18",
    ...
    },
    {
      ...
      "applicable": true,
      "result": "FAIL",
      "evidence": "技能不匹配：岗位要求React, TypeScript, Webpack，简历仅有Java相关技能；语言不匹配：要求CET-6，简历为CET-4。",
      "next_action": "block"
    },
    {
      "rule_id": "10-54",
      ...
      "applicable": true,
      "result": "PASS",
      "evidence": "最近一段经历为某互联网公司，未命中负向要求“外包经历超过2年”（华腾经历非最近一段）。",
      "next_action": "continue"
    },
    {
      "rule_id": "10-6",
    ...
    },
    {
      ...
      "applicable": true,
      "result": "FAIL",
      "evidence": "2014年毕业至2020年首份工作之间存在多年空窗且无原因说明。",
      "next_action": "block"
    },
    {
      "rule_id": "10-27",
    ...
    },
    {
      ...
      "applicable": true,
      "result": "FAIL",
      "evidence": "简历包含“华腾”经历，属于腾讯外包合作伙伴，需核实离场原因。",
      "next_action": "block"
    },
    {
      "rule_id": "10-39",
  ...
  "resume_augmentation": "## Rule Check Annotations\n\n- [10-24 ⓘ] 简历与客户原始需求的关联 — 已关联至 jr_x99\n- [10-17 ✗] 通用黑名单检验规则-高风险回流人员 — 华腾离职原因B8有犯罪记录\n- [10-5 ✗] 简历匹配硬性要求一票否决 — 技能(React/TS)与语言(CET-6)不符\n- [10-9 ✗] 简历履历空窗期检测与标记 — 毕业至首份工作间存在多年空白且无说明\n- [10-38 ✗] 腾讯历史从业经历识别与核实触发 — 包含腾讯外包(华腾)经历需核实\n- [10-8 ⓘ] 候选人意愿度校验 — 接受外包模式\n- [10-53 ⓘ] 非IEG事业群跳过内部技术面试 — PCG事业群默认跳过内测",
  "notifications": [
    {
      "recipient": "HSM",
      "channel": "InApp",
...
- **RuleCheckAudit** `rca_run_2026-05-12T03-36-01-172Z_378c95_s03-csi-blacklist-drop`
  - run_id: `run_2026-05-12T03-36-01-172Z_378c95`
  - decision: FAIL / FAIL
  - dims: client=`腾讯` BG=`PCG`
  - LLM: model=`google/gemini-3-flash-preview` duration=16333 ms tokens=10225/3343
