...
- ✅ **evidence verifiable rate ≥ 0.8 (got 89%)** — verified=16 / total=18
...
|---|---|---|---|---|---|
| 10-10 | 平均每段工作时长约31个月（2018-07至2021-02, 2021-03至2024-08），稳定性良好。 | 平均每段工作时长约, 个月, 稳定性良好 | 2018-07, 2021-02 | 平均每段工作时长约, 个月 | ✓ |
...
| 10-5 | 学历本科、必备技能React/TypeScript、年龄30岁均满足JD硬性要求。 | 学历本科, 必备技能, 年龄 | React, TypeScript | 学历本科, 必备技能 | ✓ |
...
| 10-9 | 2021-02（字节离职）至2021-03（阿里入职）间隔正常，但简历未提供空窗期原因说明字段，需记录为待补充信息。 | 字节离职, 阿里入职, 间隔正常 | 2021-02, 2021-03 | 字节离职, 阿里入职 | ✓ |
| 10-1 | 符合字节新需求下发扫描逻辑。 | 符合字节新需求下发扫描逻辑 | — | 符合字节新需求下发扫描逻辑 | ✓ |
| 10-11 | 劳务形式偏好为“正编”，与岗位招聘类型匹配。 | 劳务形式偏好为, 正编, 与岗位招聘类型匹配 | 正编 | 劳务形式偏好为, 与岗位招聘类型匹配 | ✓ |
| 10-2 | 符合字节召回逻辑。 | 符合字节召回逻辑 | — | 符合字节召回逻辑 | ✗ |
...
| 10-49 | 候选人曾于2018-07至2021-02在字节跳动任职，需上传合规凭证。 | 候选人曾于, 在字节跳动任职, 需上传合规凭证 | 2018-07, 2021-02 | 候选人曾于, 在字节跳动任职 | ✓ |
  ...
  "rule_flags": [
    {
      ...
      "applicable": true,
      "result": "PASS",
      "evidence": "平均每段工作时长约31个月（2018-07至2021-02, 2021-03至2024-08），稳定性良好。",
    ...
    },
    {
      ...
      "applicable": true,
      "result": "PASS",
      "evidence": "学历本科、必备技能React/TypeScript、年龄30岁均满足JD硬性要求。",
      "next_action": "continue"
    },
    {
      "rule_id": "10-54",
    ...
    },
    {
      ...
      "applicable": true,
      "result": "FAIL",
      "evidence": "2021-02（字节离职）至2021-03（阿里入职）间隔正常，但简历未提供空窗期原因说明字段，需记录为待补充信息。",
      "next_action": "block"
    },
    {
      "rule_id": "10-1",
    ...
    },
    {
      ...
      "applicable": true,
      "result": "FAIL",
      "evidence": "候选人曾于2018-07至2021-02在字节跳动任职，需上传合规凭证。",
...
- **RuleCheckAudit** `rca_run_2026-05-12T03-36-01-172Z_378c95_s06-bytedance-history-pause`
  - run_id: `run_2026-05-12T03-36-01-172Z_378c95`
  - decision: FAIL / FAIL
  - dims: client=`字节` BG=`TikTok`
  - LLM: model=`google/gemini-3-flash-preview` duration=19226 ms tokens=10109/3544
