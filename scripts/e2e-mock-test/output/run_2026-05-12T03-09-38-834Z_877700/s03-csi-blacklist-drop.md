...
| must-fail rules | 10-17 | 10-5:SKILL_MISMATCH, 10-14:LANGUAGE_MISMATCH, 10-17:HIGH_RISK_BLACKLIST, 10-54:OUTSOURCING_LIMIT |
...
**Verifiable rate: 47%** (≥ 80% required)

| Rule | Evidence(LLM 输出) | 提取片段 | 命中 | 未命中 | ✓/✗ |
|---|---|---|---|---|---|
| 10-5 | JD要求必备技能[React, TypeScript, Webpack], 简历技能为[Java, Spring Boot, MySQL, Redis, Kafka] | 要求必备技能, 简历技能为, React | Java, Spring | 要求必备技能, 简历技能为 | ✓ |
| 10-6 | 简历未命中JD加分项[Next.js, GraphQL] | 简历未命中, 加分项, Next | — | 简历未命中, 加分项 | ✗ |
| 10-7 | 期望薪资35k-45k在岗位薪资30k-50k范围内 | 期望薪资, 在岗位薪资, 范围内 | 35k-45k | 期望薪资, 在岗位薪资 | ✓ |
| 10-8 | outsourcing_acceptance: 接受 | 接受 | 接受 | — | ✓ |
| 10-9 | 毕业2014, 首份工作2020(简历缺失2014-2020经历), 但最近两段经历2020-03至2023-05, 2023-06至2026-04间隔1个月, 小于3个月 | 毕业, 首份工作, 简历缺失 | 2020-03, 2023-05 | 毕业, 首份工作 | ✓ |
| 10-10 | 平均每段工作时长约3年, 无消极理由空窗记录 | 平均每段工作时长约, 无消极理由空窗记录 | — | 平均每段工作时长约, 无消极理由空窗记录 | ✗ |
| 10-12 | 1988年出生, 2014年本科毕业, 毕业年龄26岁, 较基准23岁偏差3岁, 触发人工核查逻辑但此处按规则放行判定为PASS | 年出生, 年本科毕业, 毕业年龄 | — | 年出生, 年本科毕业 | ✗ |
| 10-14 | JD要求CET-6 480以上, 简历提供CET-4 | 要求, 以上, 简历提供 | CET-4, CET | 要求, 以上 | ✓ |
| 10-16 | 离职编码B8属于高风险编码, 不适用本条被动释放逻辑(由10-17处理) | 离职编码, 属于高风险编码, 不适用本条被动释放逻辑 | — | 离职编码, 属于高风险编码 | ✗ |
| 10-17 | 曾任职华腾, 离职原因编码B8: 有犯罪记录(YCH) | 有犯罪记录, 曾任职华腾, 离职原因编码 | 有犯罪记录, YCH | 曾任职华腾, 离职原因编码 | ✓ |
...
| 10-54 | JD负向要求: 不接受外包经历超过2年; 候选人华腾经历(2020-03至2023-05)已达3年2个月 | 不接受外包经历超过2年, 负向要求, 不接受外包经历超过 | 2020-03, 2023-05 | 不接受外包经历超过2年, 负向要求 | ✓ |
| 10-27 | conflict_of_interest 为空 | 为空 | — | 为空 | ✗ |
| 10-35 | nationality: 中国 | 中国, nationality | 中国, nationality | — | ✓ |
| 10-47 | gender: 男 | gender | gender | — | ✓ |
...
```json
{
  ...
  "rule_flags": [
    {
      ...
      "applicable": true,
      "result": "FAIL",
      "evidence": "JD要求必备技能[React, TypeScript, Webpack], 简历技能为[Java, Spring Boot, MySQL, Redis, Kafka]",
      "next_action": "block"
    },
    {
      "rule_id": "10-6",
      ...
      "applicable": true,
      "result": "PASS",
      "evidence": "简历未命中JD加分项[Next.js, GraphQL]",
    ...
    },
    {
      ...
      "applicable": true,
      "result": "PASS",
      "evidence": "期望薪资35k-45k在岗位薪资30k-50k范围内",
      "next_action": "continue"
    },
    {
      "rule_id": "10-8",
    ...
    },
    {
      ...
      "applicable": true,
      "result": "PASS",
      "evidence": "毕业2014, 首份工作2020(简历缺失2014-2020经历), 但最近两段经历2020-03至2023-05, 2023-06至2026-04间隔1个月, 小于3个月",
      "next_action": "continue"
    },
    {
      "rule_id": "10-10",
      ...
      "applicable": true,
      "result": "PASS",
      "evidence": "平均每段工作时长约3年, 无消极理由空窗记录",
      "next_action": "continue"
    },
    {
      "rule_id": "10-12",
      ...
      "applicable": true,
      "result": "PASS",
      "evidence": "1988年出生, 2014年本科毕业, 毕业年龄26岁, 较基准23岁偏差3岁, 触发人工核查逻辑但此处按规则放行判定为PASS",
      "next_action": "continue"
    },
    {
      "rule_id": "10-14",
      ...
      "applicable": true,
      "result": "FAIL",
      "evidence": "JD要求CET-6 480以上, 简历提供CET-4",
      "next_action": "block"
    },
    {
      "rule_id": "10-15",
    ...
    },
    {
      ...
      "applicable": true,
      "result": "PASS",
      "evidence": "离职编码B8属于高风险编码, 不适用本条被动释放逻辑(由10-17处理)",
      "next_action": "continue"
    },
    {
      "rule_id": "10-17",
      ...
      "applicable": true,
      "result": "FAIL",
      "evidence": "曾任职华腾, 离职原因编码B8: 有犯罪记录(YCH)",
      "next_action": "block"
    },
    {
      "rule_id": "10-18",
    ...
    },
    {
      ...
      "applicable": true,
      "result": "FAIL",
      "evidence": "JD负向要求: 不接受外包经历超过2年; 候选人华腾经历(2020-03至2023-05)已达3年2个月",
      "next_action": "block"
    },
    {
      "rule_id": "10-27",
  ...
  "resume_augmentation": "### 预筛风险提示\n- **黑名单命中**: 候选人曾任职华腾，离职编码为 **B8 (有犯罪记录)**，属于一票否决项。\n- **硬性技能不符**: 岗位要求 React/TypeScript/Webpack，候选人背景为 Java 后端。\n- **语言不达标**: 要求 CET-6 480+，候选人仅有 CET-4。\n- **负向经历**: 外包经历（华腾）超过 2 年限制。\n- **流程标记**: 目标 PCG 事业群，按规跳过内部技面。",
  "notifications": []
}
```
...
- **RuleCheckAudit** `rca_run_2026-05-12T03-09-38-834Z_877700_s03-csi-blacklist-drop`
  - run_id: `run_2026-05-12T03-09-38-834Z_877700`
  - decision: FAIL / FAIL
  - dims: client=`腾讯` BG=`PCG`
  - LLM: model=`google/gemini-3-flash-preview` duration=15717 ms tokens=9858/3166
