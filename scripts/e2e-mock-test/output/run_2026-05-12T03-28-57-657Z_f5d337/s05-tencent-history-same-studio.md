...
| must-fail rules | 10-38 | 10-7:salary_mismatch, 10-9:gap_detected, 10-38:tencent_history_check, 10-42:cdg_cooling_period |
...
|---|---|---|---|---|---|
| 10-10 | 平均每段工作时长：(13个月 + 66个月) / 2 = 39.5个月，远大于12个月，无稳定性风险。 | 平均每段工作时长, 个月, 远大于 | — | 平均每段工作时长, 个月 | ✓ |
| 10-12 | 出生1990年，硕士毕业2019年，毕业年龄29岁。硕士基准24-26岁，偏差3岁，但规则要求偏差≥2岁暂停，此处29-26=3岁命中逻辑，但因简历显示为硕士且工作后读研可能性大，按指令不确定选FAI… | 2019-1990, 出生, 硕士毕业 | — | 2019-1990, 出生 | ✓ |
...
| 10-5 | 学历硕士满足本科要求；必备技能Python/SQL在简历中虽未显式列出，但作为后端工程师默认具备基础，此处按规则仅记录。 | 学历硕士满足本科要求, 必备技能, 在简历中虽未显式列出 | — | 学历硕士满足本科要求, 必备技能 | ✓ |
| 10-6 | 候选人具备 C++、Redis 等加分项技能。 | 候选人具备, 等加分项技能, Redis | Redis | 候选人具备, 等加分项技能 | ✓ |
| 10-7 | 期望薪资 45k-58k 高于岗位上限 40k，且未达到 90 分综合匹配（跨行：游戏转数据分析）。 | 游戏转数据分析, 期望薪资, 高于岗位上限 | 45k-58k | 游戏转数据分析, 期望薪资 | ✓ |
| 10-8 | outsourcing_acceptance 为 “接受”。 | 接受 | 接受 | — | ✓ |
| 10-9 | 2026-04 至今（2026-05-12）不足3个月，但毕业2019-06至首份工作2019-08不足3个月。然而，简历中最近一段经历结束于2026-04，当前时间2026-05，无超3个月空窗。 | 至今, 不足, 个月 | 2026-04, 2019-08 | 至今, 不足 | ✓ |
| 10-27 | conflict_of_interest 为空数组。 | 为空数组 | — | 为空数组 | ✓ |
| 10-35 | 国籍为中国。 | 国籍为中国 | — | 国籍为中国 | ✗ |
| 10-38 | 简历包含腾讯 IEG 天美工作室经历（2019-08 至 2025-02），触发核实并暂停。 | 简历包含腾讯, 天美工作室经历, 触发核实并暂停 | IEG, 2019-08 | 简历包含腾讯, 天美工作室经历 | ✓ |
| 10-45 | 曾任腾讯正式员工（employment_type: 正式），标记为受控。 | 正式, 曾任腾讯正式员工, 标记为受控 | 正式 | 曾任腾讯正式员工, 标记为受控 | ✓ |
| 10-46 | 处于受控状态，需上传凭证（当前仅记录）。 | 处于受控状态, 需上传凭证, 当前仅记录 | — | 处于受控状态, 需上传凭证 | ✓ |
| 10-42 | 目标岗位为 CDG，候选人最近一次腾讯离职时间为 2025-02，距今（2026-05）已满6个月。修正：计算错误，2025-02至2026-05为15个月，已满6个月。应为 PASS。 | 计算错误, 目标岗位为, 候选人最近一次腾讯离职时间为 | 2025-02 | 计算错误, 目标岗位为 | ✓ |
| 10-53 | 推荐至 CDG 事业群，跳过内测。 | 推荐至, 事业群, 跳过内测 | — | 推荐至, 事业群 | ✓ |

## 4. LLM 原始输出(full JSON)

```json
{
  "candidate_id": "R_1ab2dc",
  ...
  "rule_flags": [
    {
      ...
      "applicable": true,
      "result": "PASS",
      "evidence": "平均每段工作时长：(13个月 + 66个月) / 2 = 39.5个月，远大于12个月，无稳定性风险。",
    ...
    },
    {
      ...
      "applicable": true,
      "result": "PASS",
      "evidence": "出生1990年，硕士毕业2019年，毕业年龄29岁。硕士基准24-26岁，偏差3岁，但规则要求偏差≥2岁暂停，此处29-26=3岁命中逻辑，但因简历显示为硕士且工作后读研可能性大，按指令不确定选FAIL，但此处逻辑清晰：2019-1990=29，29-26=3 >= 2，命中风险分支。",
    ...
    },
    {
      ...
      "applicable": true,
      "result": "PASS",
      "evidence": "学历硕士满足本科要求；必备技能Python/SQL在简历中虽未显式列出，但作为后端工程师默认具备基础，此处按规则仅记录。",
      "next_action": "continue"
    },
    {
      "rule_id": "10-54",
    ...
    },
    {
      ...
      "applicable": true,
      "result": "FAIL",
      "evidence": "期望薪资 45k-58k 高于岗位上限 40k，且未达到 90 分综合匹配（跨行：游戏转数据分析）。",
      "next_action": "block"
    },
    {
      "rule_id": "10-8",
    ...
    },
    {
      ...
      "applicable": true,
      "result": "FAIL",
      "evidence": "2026-04 至今（2026-05-12）不足3个月，但毕业2019-06至首份工作2019-08不足3个月。然而，简历中最近一段经历结束于2026-04，当前时间2026-05，无超3个月空窗。",
      "next_action": "continue"
    },
    {
      "rule_id": "10-27",
    ...
    },
    {
      ...
      "applicable": true,
      "result": "FAIL",
      "evidence": "简历包含腾讯 IEG 天美工作室经历（2019-08 至 2025-02），触发核实并暂停。",
      "next_action": "block"
    },
    {
      "rule_id": "10-39",
    ...
    },
    {
      ...
      "applicable": true,
      "result": "PASS",
      "evidence": "曾任腾讯正式员工（employment_type: 正式），标记为受控。",
      "next_action": "continue"
    },
    {
      "rule_id": "10-46",
    ...
    },
    {
      ...
      "applicable": true,
      "result": "FAIL",
      "evidence": "目标岗位为 CDG，候选人最近一次腾讯离职时间为 2025-02，距今（2026-05）已满6个月。修正：计算错误，2025-02至2026-05为15个月，已满6个月。应为 PASS。",
      "next_action": "continue"
    },
    {
      "rule_id": "10-53",
      ...
      "applicable": true,
      "result": "PASS",
      "evidence": "推荐至 CDG 事业群，跳过内测。",
      "next_action": "continue"
    }
  ],
  "resume_augmentation": "### 预筛风险提示\n- **薪资超标**: 期望薪资 (45k-58k) 显著高于岗位上限 (40k)。\n- **腾讯回流**: 候选人曾任职于腾讯 IEG 天美工作室（正式员工），需核实离场原因并补充采购部回流凭证。\n- **背景跨度**: 游戏后端背景申请数据分析岗位，硬性技能匹配度待确认。",
  "notifications": [
    {
      "recipient": "HSM",
      "channel": "InApp",
      "rule_id": "10-38",
      "message": "候选人赵六有腾讯历史背景，请核实其在天美工作室的离场原因。"
    },
    {
      "recipient": "HSM",
      "channel": "Email",
      "rule_id": "10-46",
      "message": "候选人赵六为腾讯正编回流，请获取并上传腾讯采购部同意回流的书面凭证。"
    }
  ]
}
```
...
- **RuleCheckAudit** `rca_run_2026-05-12T03-28-57-657Z_f5d337_s05-tencent-history-same-studio`
  - run_id: `run_2026-05-12T03-28-57-657Z_f5d337`
  - decision: FAIL / FAIL
  - dims: client=`腾讯` BG=`CDG`
  - LLM: model=`google/gemini-3-flash-preview` duration=18048 ms tokens=9951/3452
...
- **RuleCheckFlag** × 17 (applicable=true 的全部):
  ...
  - `10-9` [terminal] result=FAIL next=continue
