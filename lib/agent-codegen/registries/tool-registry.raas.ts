...
return r;`,
  ...
  },
  {
    ...
    signature: 'inviteCandidateDirect(input: { resume?: string; resume_id?: string; jd?: string; job_id?: string; candidate_email?: string; recruiter_email?: string; job_title?: string; company_name?: string; interview_language?: string; interview_duration?: number; interview_mode?: string; hiring_request_id?: string }, opts?: { traceId?: string }): Promise<{ data: { login_url?: string; reused?: boolean; success: boolean }; requestId: string }>',
...
return r;`,
  ...
  },
  {
    ...
    signature: 'writeCommunicationLogInstance(input: { communication_log_id: string; application_id?: string; message_sender?: string; message_receiver?: string; interaction_type?: string; message_content?: string; content_summary?: string; timestamp?: string }): Promise<{ ok: boolean; error?: string }>',
  ...
  },
  {
    ...
    signature: 'writeInterviewRecordInstance(input: { interview_record_id: string; application_id?: string; interviewer_employee_id?: string; interview_type?: string; interview_round?: string; interview_mode?: string; duration_minutes?: number; recording_url?: string; raw_interview_notes?: string }): Promise<{ ok: boolean; error?: string }>',
