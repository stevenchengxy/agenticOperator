...
export const AGENT_MAP: AgentMeta[] = [
  ...
  { short: 'Matcher',          wsId: '10',      stage: 'match',       kind: 'auto',   ownerTeam: '招聘运营', version: 'v2.3.1', triggersEvents: ['RESUME_PROCESSED', 'MATCH_RULE_CHECK_PASSED'], emitsEvents: ['RULE_CHECK_REQUESTED', 'MATCH_PASSED_NEED_INTERVIEW', 'MATCH_PASSED_NO_INTERVIEW', 'MATCH_FAILED'], terminal: false },
  ...
  // (subscribes MATCH_RULE_CHECK_PASSED). See docs/workflow-agents-inngest-spec.md §5.
  { short: 'RuleCheck',        wsId: '10-5',    stage: 'match',       kind: 'auto',   ownerTeam: '合规',     version: 'v1.0.0', triggersEvents: ['RULE_CHECK_REQUESTED'],                          emitsEvents: ['MATCH_RULE_CHECK_PASSED', 'MATCH_FAILED'],                                        terminal: false },
