...
const AGENT_MAP_RAAS_RAW: Omit<AgentMeta, 'domain'>[] = [
  ...
  { short: 'InterviewInviter', wsId: '11-1',    stage: 'interview',   kind: 'auto',   ownerTeam: '技术招聘', version: 'v1.0.0', triggersEvents: ['INTERVIEW_INVITATION_REQUESTED'],                  emitsEvents: ['INTERVIEW_INVITATION_SENT', 'INTERVIEW_INVITATION_FAILED'],                  terminal: false, inngestName: '面试邀约智能体', inngestId: 'interview-inviter-agent' },
