...
//   RULE_CHECK_REQUESTED → ruleCheckAgent   → MATCH_RULE_CHECK_PASSED / MATCH_FAILED
//   MATCH_RULE_CHECK_PASSED    → matchResumeAgent (2nd) → MATCH_PASSED_NO_INTERVIEW / MATCH_PASSED_NEED_INTERVIEW / MATCH_FAILED
//
