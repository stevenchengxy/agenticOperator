...
| 工作流上下文 / 事件链 | [docs/rule-check-end-to-end-workflow.md](../rule-check/rule-check-end-to-end-workflow.md) | AO 团队 |
| 测试用例跑不出预期 prompt | 本文 §9 | AO 团队 |
| OUTPUT schema 字段跟事件 payload 对不上 | 本文 §5 + [docs/rule-check-end-to-end-workflow.md](../rule-check/rule-check-end-to-end-workflow.md) | AO 团队 |
...
| [docs/rule-check-end-to-end-workflow.md](../rule-check/rule-check-end-to-end-workflow.md) | 完整工作流 + 事件设计 | ⚠️ **已过时** — 该文档基于 KEEP/DROP/PAUSE 三态,现在简化为 PASS/FAIL 二态。本文 §5 / §6 / §8 是当前权威 |
| [docs/rule-check-prompt-pipeline.md](../rule-check/rule-check-prompt-pipeline.md) | AO 这边的 RuleCheckAgent 实现细节 | 不用看 — 那是我们的事 |
