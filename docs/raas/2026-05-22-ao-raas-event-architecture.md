...
**关联文档**:
- [agent-event-flow.md](../architecture/agent-event-flow.md) — 2026-05-19 4 agent 接线细节(已被本文 §3 覆盖并扩展)
...
- [deployment-guide.md](../deploy/deployment-guide.md) §3 — Inngest URL 配置
