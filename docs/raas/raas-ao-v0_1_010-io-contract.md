...
>
> **关联文档**:
> - [docs/ao-allmeta-alignment-action-plan.md](../ontology/ao-allmeta-alignment-action-plan.md) §0 → §3 — Allmeta DataObject 终稿
...
>
> **AO 端 mapper 已 pluck 这些嵌套路径**(see [docs/ao-allmeta-alignment-action-plan.md §3.5 C.5](../ontology/ao-allmeta-alignment-action-plan.md)),写 Allmeta 时归一化。RAAS 端如果做 candidate_match_result 列表展示需要分数,**请用 `data.overallMatchScore.score` 而非 `data.matchScore`**。
...
- AO 端字段如有疑问 → 看 [docs/ao-allmeta-alignment-action-plan.md](../ontology/ao-allmeta-alignment-action-plan.md) §3 / §4
