...
> 关联:[docs/rule-check-unified-plan.md](../rule-check/rule-check-unified-plan.md) Phase 3 的第 2 项
...
[Kenny §2](../rule-check/rule-check-unified-plan.md) "partial parsed resume data" 的支撑:LLM 评估每条规则时只看它需要的简历字段(`projectResume` 投影)。
