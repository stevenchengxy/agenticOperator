...
> - 工作流定义:[docs/workflow-agents-inngest-spec.md](../architecture/workflow-agents-inngest-spec.md)
> - 三种决策事件设计:[docs/rule-check-end-to-end-workflow.md](../rule-check/rule-check-end-to-end-workflow.md)
