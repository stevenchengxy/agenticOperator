...
> 完整 endpoint 手册见同目录:[ONTOLOGY-API-USER-GUIDE-BASED-ON-NEO4J.md](../ontology/action_object_prompt/ONTOLOGY-API-USER-GUIDE-BASED-ON-NEO4J.md)(本卡只给你联调最常用的几条 + 真实连接参数)。
