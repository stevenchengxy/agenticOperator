...
| [docs/workflow-agents-inngest-spec.md](../architecture/workflow-agents-inngest-spec.md) | 现有 matchResumeAgent / Robohire 工作流 | **本文档基于这份规约,仅插入 rule check 一步,其他不动** |
...
*生成时间:基于 [docs/workflow-agents-inngest-spec.md](../architecture/workflow-agents-inngest-spec.md) Workflow A@2026-05-08 实现*
